...
class Nemesis:  # pylint: disable=too-many-instance-attributes,too-many-public-methods
    ...
    def _destroy_data_and_restart_scylla(self, number_of_files_to_destroy=1, sleep_minutes_till_restart=20, sleep_secs_till_repair=10):
        ...
        try:
            # Remove 5 data files
            self.log.debug(f'ks_cfs={ks_cfs} \n {number_of_files_to_destroy} Files to destroy')
